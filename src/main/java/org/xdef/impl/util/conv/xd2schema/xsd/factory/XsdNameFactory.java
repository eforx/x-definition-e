...
import static org.xdef.impl.util.conv.xd2schema.xsd.definition.XD2XsdFeature.XSD_NAME_COLISSION_DETECTOR;
...
public class XsdNameFactory {
    ...
    private List<XMNode> addNodeWithBaseName(final XNode xNode, final String nodeBaseName) {
        ...
        nodeList.add(xNode);
        XsdLogger.printG(LOG_INFO, XSD_NAME_FACTORY, xNode, "Add top-level " + nodeType + "-type base name. Name=" + nodeBaseName + ", SystemId=" + systemId);
        return nodeList;
    }
