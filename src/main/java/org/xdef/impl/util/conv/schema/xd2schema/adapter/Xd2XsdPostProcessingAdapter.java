...
import static org.xdef.impl.util.conv.schema.util.SchemaLoggerDefs.XSD_PP_ADAPTER;
...
//        }
//
//        final Map<String, List<UniqueConstraint>> uniqueInfoMap = adapterCtx.getSchemaUniqueConstraints(xDef.getName());
//        if (uniqueInfoMap == null || uniqueInfoMap.isEmpty()) {
//            return;
//        }
//        final List<UniqueConstraint> uniqueInfoList = uniqueInfoMap.get("");
//
